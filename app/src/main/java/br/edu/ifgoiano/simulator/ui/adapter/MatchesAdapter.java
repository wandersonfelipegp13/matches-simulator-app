...
import br.edu.ifgoiano.simulator.databinding.MatchItemBinding;
import br.edu.ifgoiano.simulator.domain.Match;
import br.edu.ifgoiano.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Adapta os dadaos da partida (recuperada da API para o nosso layout)
